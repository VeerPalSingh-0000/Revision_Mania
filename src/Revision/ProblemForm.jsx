  ...
  return (
    <div className="relative">
      <button
        ...
        className={`w-full flex items-center justify-between rounded-lg border border-slate-700 bg-slate-900/50 p-3 text-left text-slate-200 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 ${className}`}
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute z-20 w-full mt-1 bg-slate-800 border border-slate-700 rounded-lg shadow-xl max-h-48 overflow-y-auto"
          >
            {options.map((option) => (
              <button
        ...
        <AnimatePresence>
          {suggestions.length > 0 && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -5 }}
              className="absolute z-20 w-full mt-1 bg-slate-800 border border-slate-700 rounded-lg shadow-xl"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Key insight, approach used, or things to remember..."
                    rows={3}
                    className="w-full rounded-lg border border-slate-700 bg-slate-900/50 p-3 text-slate-200 placeholder:text-slate-500 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 resize-none"
                    disabled={isLoading}
                  />
                </div>
