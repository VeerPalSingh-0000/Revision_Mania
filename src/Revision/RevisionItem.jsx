        ...
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 mb-2 flex-wrap">
              ...
              {problem.difficulty && (
                <span
                  className={`px-2 py-1 rounded-md text-xs font-medium whitespace-nowrap ${getDifficultyColor(problem.difficulty)}`}
                >
                  {problem.difficulty}
                </span>
              )}
            ...
            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex-shrink-0 ml-2">
              {isRevision && (
                <button
                  ...
                  disabled={!canUndo}
                  className={`flex h-8 w-8 items-center justify-center rounded-lg transition-all duration-200 ${canUndo ? "text-orange-400 bg-orange-500/20 hover:bg-orange-500/30 cursor-pointer" : "text-slate-500 bg-slate-700/20 cursor-not-allowed"}`}
                  title={
                    canUndo
                      ? "Undo this revision"
                      : "Undo time limit has passed"
                  }
                  type="button"
                >
                  <FiUndo />
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg text-emerald-400 bg-emerald-500/20 transition-colors duration-200 hover:bg-emerald-500/30"
              ...
              <button
                ...
                className={`flex items-center justify-center rounded-lg transition-all duration-200 ${isDeleting ? "h-8 w-20 bg-red-500/30 text-red-400" : "h-8 w-8 text-red-400 bg-red-500/20 hover:bg-red-500/30"}`}
