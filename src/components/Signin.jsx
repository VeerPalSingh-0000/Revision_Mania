...
export default function SignIn({ onSwitchToSignUp }) {
    ...
    const handlePasswordReset = async () => {
        if (!email) {
            addToast('Enter your email to receive a reset link.', 'error');
            return;
        }
        setIsLoading(true);
